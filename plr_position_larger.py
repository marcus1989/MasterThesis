...
#print len(plr_destinations),len(clustal_files),len(pdb_files),len(fasta_files),len(conserved)
for ipdb,pdb_file in enumerate(pdb_files):
	...
	#print len(pdb_dict3),plr_destination
	#break
